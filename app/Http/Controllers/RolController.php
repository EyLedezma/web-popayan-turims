...
class RolController extends Controller
{
    ...
    {
        $rols = Rol::paginate();
        $permiso = Permiso::pluck('nombre');
        return view('rol.index', compact('rols','permiso'))
    ...
    {
        $rol = new Rol();
        $permiso = Permiso::pluck('nombre','id');
        return view('rol.create', compact('rol','permiso'));
    }
    ...
    public function edit($id)
    {
        $rol = Rol::find($id);
        $permiso = Permiso::pluck('nombre');
        return view('rol.edit', compact('rol','permiso'));
    }
